...
def load_piper_interface_v2() -> Any:
    repo_vendor_sdk = Path(__file__).resolve().parents[3] / "vendor" / "piper_sdk"
    if repo_vendor_sdk.exists() and str(repo_vendor_sdk) not in sys.path:
        sys.path.insert(0, str(repo_vendor_sdk))
